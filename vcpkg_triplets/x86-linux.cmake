...
# with "target specific option mismatch". Enable SSE2/SSE3 with SSE math
# (-mfpmath=sse) to satisfy them.
set(VCPKG_C_FLAGS "${VCPKG_C_FLAGS} -msse2 -msse3 -mfpmath=sse")
set(VCPKG_CXX_FLAGS "${VCPKG_CXX_FLAGS} -msse2 -msse3 -mfpmath=sse")