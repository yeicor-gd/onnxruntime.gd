...
vcpkg_replace_string("${SOURCE_PATH}/cmake/CMakeLists.txt" "set(CMAKE_CUDA_STANDARD 17)" "set(CMAKE_CUDA_STANDARD 20)")
...
if("cuda" IN_LIST FEATURES)
    ...
    list(APPEND FEATURE_OPTIONS
        ...
        "-DCMAKE_CUDA_FLAGS=-Xcudafe --diag_suppress=2803 -Wno-deprecated-gpu-targets -std=c++20 -Xcompiler -Wno-template-body"
    )
endif()
